...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=80b97dfdffb44e682a143a3a8b9a8430"></script>
        ...
        $.ajax({
            ...
            success : function(array) {
                ...
                var mapContainer = document.getElementById('map'), // 지도를 표시할 div
                    mapOption = {
                        center: new kakao.maps.LatLng(37.5254157, 126.9215157), // 지도의 중심좌표
                        level: 18 // 지도의 확대 레벨
                    };
